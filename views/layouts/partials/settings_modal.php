        ...
        @click.self="settingsModalOpen = false">
         ...
         <div class="settings-modal-shell">
           ...
           <div class="settings-mobile-header">
             <span style="font-size:16px; font-weight:700; color:var(--modal-text);" v-text="settingsActiveTab === 'general' ? 'General' : settingsActiveTab === 'profile' ? 'Profile' : settingsActiveTab === 'appearance' ? 'Appearance' : 'Report Settings'"></span>
           </div>
           ...
           <div class="settings-modal-sidebar">
             ...
             <!-- General Tab -->
             <button @click="selectSettingsTab('general')"
             ...
             <!-- Profile Tab -->
             <button @click="selectSettingsTab('profile')"
               class="settings-tab-btn"
             ...
             <!-- Appearance Tab -->
             <button @click="selectSettingsTab('appearance')"
               class="settings-tab-btn"
             ...
             <button v-if="role === 'radtech' || role === 'radiologist'" @click="selectSettingsTab('reports')"
               class="settings-tab-btn"
               :class="{ active: settingsActiveTab === 'reports' }">
             ...
             <div
               style="margin-top:auto;padding-top:20px;border-top:1px solid var(--modal-border, #e5e7eb);padding-top:16px;">
               <div style="padding:0 10px;">
                 <div
                   style="font-size:10px;color:#d1d5db;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;">
                   CitiLife System</div>
           ...
           <div class="settings-modal-content">
            ...
            <div v-show="settingsActiveTab === 'general'">
              ...
              <div class="settings-flex-row"
                ...
                <label
                  style="position:relative;display:inline-block;width:42px;height:24px;flex-shrink:0;cursor:pointer;">
            ...
            <div v-show="settingsActiveTab === 'appearance'">
              ...
              <!-- SECTION: Theme -->
              <p style="font-size:10px;font-weight:700;color: var(--modal-text-light, #9ca3af);text-transform:uppercase;letter-spacing:0.08em;margin:0 0 10px 0;">Theme</p>
              ...
              <div class="settings-flex-row"
                ...
                <div>
                  ...
                  <div style="font-size:11px;color:var(--modal-text-light,#9ca3af);margin-top:2px;">Choose between light, dark, or system default</div>
                </div>
                ...
                <div style="position:relative;flex-shrink:0;" ref="themeDropdownRef">
                  <button @click="themeDropdownOpen = !themeDropdownOpen"
                    ...
                    <span style="display:flex;align-items:center;gap:6px;">
                      <span v-show="themeMode === 'system'" style="display:flex;align-items:center;"><i data-lucide="monitor" style="width:14px;height:14px;"></i></span>
                      <span v-show="themeMode === 'dark'" style="display:flex;align-items:center;"><i data-lucide="moon" style="width:14px;height:14px;"></i></span>
                      <span v-show="themeMode === 'light'" style="display:flex;align-items:center;"><i data-lucide="sun" style="width:14px;height:14px;"></i></span>
                  ...
                  <div v-show="themeDropdownOpen"
                    ...
                    <button @click="setTheme('system'); themeDropdownOpen = false"
                      ...
                      <span v-show="themeMode === 'system'" style="display:flex;align-items:center;"><i data-lucide="check" style="width:14px;height:14px;color:#dc2626;"></i></span>
                    </button>
                    <button @click="setTheme('light'); themeDropdownOpen = false"
                      ...
                      <span v-show="themeMode === 'light'" style="display:flex;align-items:center;"><i data-lucide="check" style="width:14px;height:14px;color:#dc2626;"></i></span>
                    </button>
                    <button @click="setTheme('dark'); themeDropdownOpen = false"
                      ...
                      <span v-show="themeMode === 'dark'" style="display:flex;align-items:center;"><i data-lucide="check" style="width:14px;height:14px;color:#dc2626;"></i></span>
                    </button>
                  </div>
                </div>
              </div>
            ...
            <div v-show="settingsActiveTab === 'reports'">
              <h3 style="font-size:18px;font-weight:700;color: var(--modal-text, #111827);margin:0 0 16px 0;">Report Settings</h3>
              <div style="height:1px;background-color: var(--modal-border-light, #f3f4f6);margin-bottom:24px;"></div>
