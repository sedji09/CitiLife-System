  ...
  const app = createApp({
    ...
    mounted() {
      ...
      if (this.role !== 'patient') {
        ...
        try {
          const saved = JSON.parse(sessionStorage.getItem('citilife_active_chats_' + this.userId) || '[]');
    ...
    methods: {
      ...
      saveActiveChats() {
        try {
          ...
          sessionStorage.setItem('citilife_active_chats_' + this.userId, JSON.stringify(toSave));
