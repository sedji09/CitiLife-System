    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Patient Profile</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Case #<?= htmlspecialchars($patient['patient_number'] ?? 'N/A') ?></p>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                    <div class="p-6 flex flex-col sm:flex-row items-center gap-6">
                        <?php if (!empty($patient['avatar'])): ?>
                            <img src="<?= htmlspecialchars($patient['avatar']) ?>" alt="Profile Picture" class="h-24 w-24 rounded-2xl object-cover shadow-sm border border-gray-200 dark:border-gray-700 shrink-0">
                        <?php else: ?>
                            <div class="h-24 w-24 rounded-2xl bg-red-50 dark:bg-red-900/30 flex items-center justify-center text-red-600 dark:text-red-400 border border-red-100 dark:border-red-800/50 shrink-0">
                        ...
                        <div class="flex-1 text-center sm:text-left">
                            ...
                            <div class="flex flex-wrap items-center justify-center sm:justify-start gap-3 mt-2">
                                <span class="px-2.5 py-0.5 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-[11px] font-bold uppercase tracking-wider">
                                    <?= htmlspecialchars($patient['sex'] ?? 'N/A') ?>
                                </span>
                                <span class="px-2.5 py-0.5 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[11px] font-bold border border-blue-100 dark:border-blue-800/50 uppercase tracking-wider">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8">
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Phone Number</label>
                            <p class="text-sm font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                        ...
                        <div class="space-y-1 sm:col-span-2">
                            <label class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Home Address</label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Registered Date</label>
                            <p class="text-sm font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                 ...
                 <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl p-6 text-white relative overflow-hidden group">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1">
                         ...
                         <div class="space-y-1">
                            <p class="text-2xl font-bold text-emerald-400"><?= (int)($patientStats['branches_visited'] ?? 0) ?></p>
                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">Branches Visited</p>
                        </div>
                    </div>
