    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <a href="<?= PROJECT_DIR ? '/' . PROJECT_DIR . '/' : '/' ?>patient-records" data-back-btn data-fallback="<?= PROJECT_DIR ? '/' . PROJECT_DIR . '/' : '/' ?>patient-records" title="Back"
            ...
            <div class="flex items-center gap-2">
                <a href="<?= PROJECT_DIR ? '/' . PROJECT_DIR . '/' : '/' ?>records-history?patient_number=<?= urlencode($patient['patient_number']) ?>"
