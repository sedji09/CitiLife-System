        ...
        <div id="report-scroller">
                ...
                <div class="page" id="main-report-page">
                    ...
                    <div class="report-header">
                        <div class="header-left">
                            <img src="<?= getSystemLogoUrl() ?>" alt="<?= htmlspecialchars(getSystemName()) ?> Logo" class="header-logo">
                    ...
                    <div class="footer-group">
                        ...
                        <div
                            ...
                            <p
                                style="font-family: Arial, sans-serif; font-size: 8.5pt; color: #555; line-height: 1.4; margin: 0;">
                                This document contains sensitive patient information. Unauthorized access,
            ...
            <?php foreach ($images as $idx => $imgSrc): ?>
                ...
                <div class="page image-plate">
                    ...
                    <div style="width: 100%; text-align: center; margin-bottom: 20px; font-family: 'Raleway', sans-serif; position: relative; z-index: 1;">
                        <h2
                        ...
                        <p style="font-family: Arial, sans-serif; font-size: 10pt; color: #555; margin: 0 0 5px 0;">
