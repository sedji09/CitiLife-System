...
<script>
    ...
    function openPaymentModal(caseId, amount, originalPrice, philhealthDiscount, gcashQrPath, examType, rejectionReason) {
        ...
        if (gcashQrPath && gcashQrPath.trim() !== '') {
            ...
            const cleanPath = gcashQrPath.startsWith('/') ? gcashQrPath.substring(1) : gcashQrPath;
            document.getElementById('qrCodeImage').src = projectBase + cleanPath;
            document.getElementById('qrCodeDownload').href = projectBase + cleanPath;
        } else {
