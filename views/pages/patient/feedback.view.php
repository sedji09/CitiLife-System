<div class="max-w-4xl mx-auto space-y-6 p-4 md:p-6 pb-24">
    ...
    <div class="flex items-center gap-3">
        <a href="<?= PROJECT_DIR ? '/' . PROJECT_DIR . '/' : '/' ?>index.php?role=patient&page=my-records" data-back-btn data-fallback="<?= PROJECT_DIR ? '/' . PROJECT_DIR . '/' : '/' ?>index.php?role=patient&page=my-records" title="Back" class="p-2 rounded-lg bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-red-600 transition shadow-sm">
