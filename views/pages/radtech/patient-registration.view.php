        ...
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex space-x-2" aria-label="Tabs">
                <button type="button" onclick="switchTab('new-patient')" id="tab-new"
                    class="border-red-500 text-red-600 whitespace-nowrap border-b-2 py-2.5 px-1 text-sm font-medium focus:outline-none">
                    New Patient
                </button>
                <button type="button" onclick="switchTab('existing-patient')" id="tab-existing"
                    class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 whitespace-nowrap border-b-2 py-2.5 px-1 text-sm font-medium focus:outline-none">
                    Returning Patient
                </button>
            </nav>
        </div>
