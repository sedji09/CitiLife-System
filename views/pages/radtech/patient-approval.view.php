...
<!-- Assign Exam Modal -->
<div id="assignModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 hidden p-4 overflow-y-auto">
    <div class="w-full max-w-lg p-6 border shadow-2xl rounded-2xl bg-white overflow-visible relative">
