...
<!-- Header -->
<div class="flex items-center justify-between border-b border-gray-200 pb-4 mt-6">
    <div>
        <h2 class="text-xl font-semibold text-gray-900">Completed Records</h2>
        <p class="text-sm text-gray-500 mt-1">Manage completed records and view reports</p>
    </div>
</div>
