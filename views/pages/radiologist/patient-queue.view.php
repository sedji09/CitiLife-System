...
<div class="flex items-center gap-4 py-2 mb-4">
    <a href="?role=radiologist&page=worklist" class="flex w-10 h-10 items-center justify-center rounded-xl bg-white border border-gray-200 shadow-sm text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors mt-1">
