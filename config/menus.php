...
return [
  ...
  "admin_central" => [
    ...
    ["label" => "Service Pricing", "icon" => "tag", "href" => "/service-pricing", "perm_key" => "service_pricing"],
    ["label" => "Patient Records", "icon" => "folder-open", "href" => "/patient-records", "perm_key" => "patient_history"],
    ["label" => "Patient Feedback", "icon" => "message-square", "href" => "/feedback", "perm_key" => "patient_feedback"],
  ...
  "system_feature_menus" => [
    ...
    "service_pricing" => ["label" => "Service Pricing", "icon" => "tag", "href" => "/service-pricing", "perm_key" => "service_pricing"],
    ...
    "patient_feedback"=> ["label" => "Patient Feedback", "icon" => "message-square", "href" => "/feedback", "perm_key" => "patient_feedback"],
  ]
];