...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        if ($user) {
            ...
            $resetLink = $protocol . $_SERVER['HTTP_HOST'] . '/' . PROJECT_DIR . '/reset-password.php?token=' . $token;
    ...
    <div class="glass-panel w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-8">
        ...
        <div class="mt-8 pt-6 border-t border-gray-100 text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="login.php" class="font-bold text-red-600 hover:underline">Back to Login</a>
            </p>
        </div>
    </div>
</body>
